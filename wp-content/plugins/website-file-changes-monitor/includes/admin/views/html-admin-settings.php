				...
				<td>
					<fieldset>
						...
						<label for="email-notice-custom">
							...
							<input type="email" id="notice-email-address" name="wfcm-settings[<?php echo esc_attr( WFCM_Settings::NOTIFY_ADDRESSES ); ?>]" multiple pattern="[a-z0-9!#$%&'*+/=?^_`{|}~.-]+@[a-z0-9-]+(\.[a-z0-9-]+)*" value="<?php echo esc_attr( $email_custom_list ); ?>">
						</label>
						<br />
						...
						<div id="wfcm-test-email-response" class="hidden">
							...
							<p><?php echo sprintf( esc_html__( 'Oops! Email sending failed. Please %s for assistance.', 'website-file-changes-monitor' ), '<a href="https://melapress.com/support/?utm_source=plugins&utm_medium=link&utm_campaign=wfcm" target="_blank">' . esc_html__( 'contact us', 'website-file-changes-monitor' ) . '</a>' ); ?></p>
						</div>
					</fieldset>
				</td>
			</tr>
				...
				<tr>
					...
					<td>
						...
						<div id="wfcm-scan-response" class="hidden">
							<?php /* Translators: Contact us hyperlink */ ?>
							<p><?php echo sprintf( esc_html__( 'Oops! Something went wrong with the scan. Please %s for assistance.', 'website-file-changes-monitor' ), '<a href="https://melapress.com/support/?utm_source=plugins&utm_medium=link&utm_campaign=wfcm" target="_blank">' . esc_html__( 'contact us', 'website-file-changes-monitor' ) . '</a>' ); ?></p>
						</div>
					</td>
				</tr>
			</tbody>
