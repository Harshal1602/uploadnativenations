...
add_action(
	...
	*/
	function () {
		require_once __DIR__ . '/alerts/class-wfcm-custom-alerts.php';

		\WSAL\Helpers\Classes_Helper::add_to_class_map(
			array(
				'WSAL\\Custom_Alerts\\WFCM_Custom_Alerts' => __DIR__ . '/alerts/class-wfcm-custom-alerts.php',
			)
		);
	}
);
...
add_action(
	...
	*/
	function () {
		require_once __DIR__ . '/sensors/class-wfcm-sensor.php';

		\WSAL\Helpers\Classes_Helper::add_to_class_map(
			array(
				'WSAL\\Plugin_Sensors\\WPFS_Sensor' => __DIR__ . '/alerts/class-wfcm-sensor.php',
			)
		);
	}
);
